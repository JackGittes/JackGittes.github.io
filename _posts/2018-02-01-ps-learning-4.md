...
本节没有详细的定调方法的内容，因为这要牵涉到很多美术知识，以后找机会再详细地写调色定调的内容。但是这节给出了一个非常适合初学者的快速定调子的方法——Lightroom预设文件，同时强调了后期的一个观念——调性优先。
...
在预设文件基础之上，我们可以进行一些微调，而且还可以借鉴预设文件的参数设置和调节方法。下面有几个国外比较好的LR预设文件分享网站：
- [Preset Love](http://presetlove.com/)
- [10 Free Lightroom Presets Inspired by VSCO Cam](http://natephotographic.com/vsco-cam-lightroom-presets-starter-pack/)
- [skelens.com](https://sleeklens.com/product/the-starter-pack-lightroom-presets/)
- [Presets Heaven](https://www.presetsheaven.com/)
