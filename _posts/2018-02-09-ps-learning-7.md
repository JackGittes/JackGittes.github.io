...
### 三、合成时的匹配问题
在合成过程中，需要合成的素材之间应该做好匹配工作。其一是分辨率匹配，要合成的素材间的分辨率应该大体一致，否则一张来自低分辨率的图片合到一张高分辨率图片上会显得非常不协调。其二是透视匹配，要合成的素材间的透视关系应该掌握好，比如想在一幅图中增加一个建筑，原图是平视视角拍摄的图片，那么加入的建筑物也应当是平视视角拍摄的，否则两图之间的透视关系不一致，很容易就能看出破绽。
...
### 四、一些细节问题
除了以上提到的合成技巧之外，积累对照片的感觉也很重要，应该慢慢丰富对图片的形容词，例如高饱和、高明度、低饱和、低调、阴沉、浓郁、素雅。这些感受和形容词的积累有助于在合成的时候更好地统一不同素材的风格，使合成可以更加和谐。

例如下面的照片里，最左是原图，中间是合成了蓝天之后的片子，显然合成的蓝天看起来怪怪的。这是因为原图整体是低饱和的，而天空鲜亮的蓝色跟整体风格不融合，最右侧降低了蓝天饱和度的照片看起来则更协调一致。

<center>
<img src="http://wx2.sinaimg.cn/large/41f56ddcgy1fpbm9lptkcj21io0emte1.jpg" width="700px">
</center>
